...
resource "ibm_scc_profile_attachment" "scc_profile_attachment_fs" {
  ...
  attachment_parameters {
    parameter_name = "public_endpoints_with_mfa_enabled"
    parameter_display_name =  "CBR public endpoint are enabled with MFA"
  ...
  attachment_parameters {
    parameter_name = "public_endpoints_with_mfa_enabled"
    parameter_display_name =  "CBR public endpoints are enabled with MFA"
    parameter_type =  "string_list"
    parameter_value =  "['OFF']"
    assessment_type =  "automated"
    assessment_id =  "rule-61878b48-e181-455d-aed3-5730b6e27890"
